...
const someKeys = {
  ...
  client_x509_cert_url:
    'https://www.googleapis.com/robot/v1/metadata/x509/secondbot%40secondbot-363521.iam.gserviceaccount.com',
};

const auth = new google.auth.GoogleAuth({
  keyFile: './src/plugin/googleSheets/credentials.json',
  // credentials: someKeys,
  scopes: scopes,
  // scopes: "https://www.googleapis.com/auth/spreadsheets" //work too
});

// Create client instance for auth
const client: any = auth.getClient();
...
const insertResultSheets = async (
  firstName,
  phoneNumber,
  email,
  chanelSpeak,
